...
class DocuSignAPITester:
    def __init__(self, base_url="https://transport-hub-164.preview.emergentagent.com/api"):
    ...
    def test_docusign_auth_url(self):
        ...
        try:
            redirect_uri = "https://transport-hub-164.preview.emergentagent.com/docusign-callback"
